...
const rawlist = JSON.parse(fs.readFileSync('/tmp/missing_batch5.json', 'utf8'));
...
async function main() {
    ...
    fs.writeFileSync('/tmp/generated_cocktails_v5.json', JSON.stringify(allCocktails, null, 4));
    console.log("DONE! Wrote full JSON array to /tmp/generated_cocktails_v5.json");
}
