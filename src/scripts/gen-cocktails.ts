...
const cocktailsToAdd = [
    "Jack Rose", "Bee's Knees", "Sherry Cobbler", "Dirty Martini", "Perfect Martini",
    "Scotch & Soda", "Horse's Neck", "Final Ward", "Kingston Negroni", "White Negroni",
    "Benton's Old Fashioned", "Planter's Punch", "Rum Barrel", "Batida", "Chilcano",
    "Fernandito", "Rabo de Galo", "Ti' Punch", "Carajillo", "Sangrita", "Sgroppino",
    "Garibaldi", "Bicicletta", "Grasshopper", "Brandy Alexander", "Golden Cadillac",
    "B-52", "Stinger", "Gin Rickey", "Whiskey Highball", "Suffering Bastard",
    "Japanese Cocktail", "Clarified Milk Punch", "Fat-Washed Old Fashioned",
    "Pineapple Mezcal Sour", "Matcha Martini", "Yuzu Collins"
];
...
async function main() {
    ...
    fs.writeFileSync('/tmp/generated_cocktails.json', JSON.stringify(allCocktails, null, 4));
    console.log("DONE! Wrote full JSON array to /tmp/generated_cocktails.json");
}
