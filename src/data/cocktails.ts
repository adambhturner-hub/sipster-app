...
export const CLASSIC_COCKTAILS: Cocktail[] = [
    ...
    },
    {
        ...
        description: 'A Prohibition-era classic that brilliantly used sweet honey and sharp citrus to mask the harsh flavor of bathtub gin. Today, made with quality gin, it\'s a bright, floral delight.',
        garnish: 'Lemon twist',
        instructions: [
            'Prepare honey syrup by mixing equal parts hot water and honey until dissolved, then letting it cool.',
            'Add the gin, fresh lemon juice, and honey syrup to a cocktail shaker.',
            'Fill with ice and shake vigorously for 10-15 seconds until well-chilled.',
            'Double strain into a chilled coupe glass.',
            'Express the oils from a lemon twist over the drink and drop it in.'
        ],
        season: 'Spring',
        recommendedAmount: '1 Drink',
        quantity: 1,
        relationship: ['Gold Rush', 'Gimlet', 'Sidecar'],
        source: 'Frank Meier',
        city: 'Paris',
        mood: 'Sunny & Crisp',
        ...
        timePeriod: '1920s',
        trivia: [
            'The term "Bee\'s Knees" was 1920s slang for "the best" or "outstanding".',
            'It was reportedly invented by Frank Meier, an Austrian-born bartender who worked at the Ritz in Paris during the 1920s.',
            'Substituting standard simple syrup completely changes the drink; the rich floral notes of the honey are absolutely essential.'
        ],
        ratio: '2:¾:½',
        tagline: 'Prohibition slang for perfection.',
        strength: 5,
        estimatedCost: 2,
        popularity: 88,
        totalMixes: 350000,
    ...
    },
    {
        ...
        description: 'A deliciously spicy, rich Bermudan highball. The sharp bite of ginger beer perfectly slices through the heavy molasses and vanilla notes of the dark rum.',
        garnish: 'Lime wedge',
        instructions: [
            'Fill a highball glass with ice.',
            'Pour in the ginger beer and fresh lime juice.',
            'Carefully float the dark rum on top so it looks like a dark storm cloud.',
            'Garnish with a lime wedge (and stir before drinking).'
        ],
        season: 'Year-Round',
        recommendedAmount: '1 Drink',
        quantity: 1,
        relationship: ['Moscow Mule', 'Kentucky Mule', 'Rum Punch'],
        source: 'Gosling Brothers',
        city: 'Bermuda',
        mood: 'Stormy & Spiced',
        flavorProfile: ['Spiced', 'Sweet', 'Fizzy'],
        difficultyLevel: 'Beginner',
        occasion: 'Sailing',
        abvContent: 'Medium',
        temperature: 'Cold',
        countryOfPopularity: 'Bermuda / USA',
        timePeriod: '1920s',
        trivia: [
            'The name is legally trademarked by Gosling\'s Rum. Technically, if you make this drink with any rum other than Gosling\'s Black Seal, it is illegal to call it a Dark \'n\' Stormy on a menu.',
            'It was invented in Bermuda shortly after World War I, when British naval officers mixed local rum with their ginger beer rations.',
            'The drink must have a "floating" layer of dark rum on top, resembling a dark storm cloud over the ginger beer ocean.'
        ],
        ratio: '2:3:½',
        tagline: 'A spicy, legally-protected Bermudan storm.',
        strength: 5,
        estimatedCost: 2,
        popularity: 88,
        totalMixes: 450000,
    ...
    },
    {
        ...
        glass: 'Highball',
        ingredients: [
            { amount: '3 oz', item: 'Jamaican Dark Rum' },
            { amount: '1 oz', item: 'Lime Juice' },
            { amount: '3/4 oz', item: 'Simple Syrup' },
            { amount: '1/4 oz', item: 'Grenadine' },
            { amount: '3 dashes', item: 'Angostura Bitters' }
        ],
        description: 'The foundational architectural blueprint for all tropical rum drinks. It is effectively a massive, bold Jamaican rum sour built over crushed ice with aggressive dashes of aromatic bitters.',
        garnish: 'Mint sprig and lime wheel',
        instructions: [
            'Add the dark rum, lime juice, simple syrup, grenadine, and bitters to a shaker.',
            'Fill with ice and shake violently to chill.',
            'Strain into a large highball or hurricane glass filled completely with crushed ice.',
            'Add a dash of bitters over the top of the ice.',
            'Garnish with a smacked mint sprig and a lime wheel.'
        ],
        season: 'Summer',
        recommendedAmount: '1 Drink',
        quantity: 1,
        relationship: ['Mai Tai', 'Rum Punch', 'Zombie'],
        source: 'Myers\'s Rum',
        city: 'Kingston',
        mood: 'Tropical & Heavy',
        flavorProfile: ['Funky', 'Tart', 'Spiced'],
        difficultyLevel: 'Intermediate',
        occasion: 'Patio Sipping',
        abvContent: 'High',
        temperature: 'Cold',
        countryOfPopularity: 'Jamaica / USA',
        timePeriod: '1870s',
        trivia: [
            'The historic recipe rhyme for Caribbean punch is: "One of Sour, Two of Sweet, Three of Strong, Four of Weak".',
            'It was popularized heavily in America in the 1920s to market Myers\'s Jamaican Rum.',
            'It is crucial to use a funky, high-ester Jamaican rum. A clean, light Spanish-style rum will get completely lost beneath the lime and bitters.'
        ],
        ratio: '3:1:¾:¼',
        tagline: 'The historic blueprint for all Caribbean rum drinks.',
        strength: 7,
        estimatedCost: 3,
        popularity: 65,
        totalMixes: 120000,
    ...
    },
    {
        ...
        ingredients: [
            ...
            { amount: '1 oz', item: 'Lime Juice' },
            { amount: '3/4 oz', item: 'Simple Syrup' },
            { amount: '10 leaves', item: 'Mint' },
            { amount: '4 dashes', item: 'Angostura Bitters' }
        ],
        description: 'A spectacularly complex cousin to the Mojito. Hailing from Trinidad, it relies heavily on dark Demerara rum and an assertive top layer of Angostura bitters.',
        garnish: 'Mint sprig and heavy bitters float',
        instructions: [
            'In a tall highball glass, gently muddle the mint leaves with the simple syrup.',
            'Add the Demerara rum and lime juice.',
            'Fill the glass halfway with crushed ice, then insert a swizzle stick (or barspoon) and spin it wildly between your palms to mix and chill.',
            'Fill the rest of the glass to the brim with more crushed ice.',
            'Dash the Angostura bitters heavily over the top of the ice to create a dark crimson layer.',
            'Garnish with a sprawling fresh mint sprig.'
        ],
        season: 'Summer',
        recommendedAmount: '1 Drink',
        quantity: 1,
        relationship: ['Mojito', 'Mint Julep', 'Planter\'s Punch'],
        source: 'Queen\'s Park Hotel',
        city: 'Port of Spain',
        mood: 'Complex & Refreshing',
        flavorProfile: ['Spiced', 'Minty', 'Tart', 'Complex'],
        difficultyLevel: 'Advanced',
        occasion: 'Patio Sipping',
        abvContent: 'Medium',
        temperature: 'Cold',
        countryOfPopularity: 'Trinidad / USA',
        timePeriod: '1920s',
        trivia: [
            'Created at the incredibly opulent Queen\'s Park Hotel in Port of Spain, Trinidad, which was a hotspot for wealthy travelers before World War II.',
            'A true swizzle is created using a "Bois Lélé", a natural multi-pronged stick from a Caribbean swizzle stick tree, spun fast between the hands to freeze the outside of the glass.',
            'Trader Vic famously called this "the most delightful form of anesthesia given out today."'
        ],
        ratio: '2:1:¾',
        tagline: 'The Mojito\'s darker, infinitely more complex sibling.',
        strength: 5,
        estimatedCost: 3,
        popularity: 58,
        totalMixes: 75000,
