            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        <Link href="/menu" className="text-gray-400 hover:text-[var(--primary)] hover:drop-shadow-[0_0_8px_var(--primary-glow)] transition-all flex items-center justify-center p-2" title="Search Catalog">
                    ...
                    <div className="md:hidden flex items-center gap-2">
                        <Link href="/menu" className="text-gray-300 hover:text-[var(--primary)] p-2" title="Search Catalog">
